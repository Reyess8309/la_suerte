                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <!-- Botón Generar reporte -->
                     <div class="flex items-end space-x-2">
                        ...
                        <button type="submit" formaction="{{ route('reportes.ganadores.pdf') }}" class="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300">
                            PDF
                        </button>
                    </div>
                </div>
